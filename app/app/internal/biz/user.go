...
func (uuc *UserUseCase) UserInfo(ctx context.Context, user *User) (*v1.UserInfoReply, error) {
	...
	return &v1.UserInfoReply{
		...
		BuyNumOne:             count1,
		BuyNumSix:             count6,
		SellNumOne:            float64(buyOne-count1) / float64(buyOne),
		SellNumTwo:            float64(buyTwo-count2) / float64(buyTwo),
		SellNumThree:          float64(buyThree-count3) / float64(buyThree),
		SellNumFour:           float64(buyFour-count4) / float64(buyFour),
		SellNumFive:           float64(buyFive-count5) / float64(buyFive),
		SellNumSix:            float64(buySix-count6) / float64(buySix),
		DailyRate:             0,
		BiwDailySpeed:         0,
